...
class LabgridStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ExporterStream = channel.stream_stream(
                '/labgrid.Labgrid/ExporterStream',
        ...
        self.DeletePlaceAlias = channel.unary_unary(
                '/labgrid.Labgrid/DeletePlaceAlias',
        ...
        self.SetPlaceComment = channel.unary_unary(
                '/labgrid.Labgrid/SetPlaceComment',
        ...
        self.DeletePlaceMatch = channel.unary_unary(
                '/labgrid.Labgrid/DeletePlaceMatch',
        ...
        self.CreateReservation = channel.unary_unary(
                '/labgrid.Labgrid/CreateReservation',
        ...
        self.CancelReservation = channel.unary_unary(
                '/labgrid.Labgrid/CancelReservation',
        ...
        self.PollReservation = channel.unary_unary(
                '/labgrid.Labgrid/PollReservation',
        ...
        self.GetReservations = channel.unary_unary(
                '/labgrid.Labgrid/GetReservations',
...
def add_LabgridServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'labgrid.Labgrid', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('labgrid.Labgrid', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class Labgrid(object):
    """Interface exported by the server.
    """
